...
// ValidateFrontmatter and ValidateFrontmatterSyntax live in
// validate_cue.go (native) and validate_wasm.go (the no-op stub):
// both compile CUE, which the WASM build omits. See the doc comments
// there.
