...
// userConventions first, then the built-in table. When name is not
// found in either map it returns an error that lists both sets of
// valid names. userConventions may be nil; it is treated as empty.
//
