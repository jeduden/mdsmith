...
- **Name**: `token-budget`
- **Status**: ready
- **Default**: enabled, max: 8000, mode: heuristic, tokens-per-word: 0.75,
...
| `tokens-per-word` | number | 0.75          | Tokens per word multiplier used in `heuristic` mode                                  |
