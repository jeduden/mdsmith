...
| [MDS041](MDS041-no-inline-html/README.md)                     | `no-inline-html`                     | ready     | Flags raw HTML in Markdown (block and inline). Tags in the allow list and HTML comments with allow-comments enabled are skipped. |
<?/catalog?>
