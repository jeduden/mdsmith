...
| [MDS059](MDS059-blockquote-whitespace/README.md)              | `blockquote-whitespace`              | whitespace    | ready     | Blockquote markers must be followed by one space, and adjacent blockquote blocks must not be separated by blank lines.                             |
