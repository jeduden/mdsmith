...
| [Choose between inline and file-based kinds](inline-vs-file-kinds.md)               | Decide whether to declare a kind inline in `.mdsmith.yml` or as its own file under `.mdsmith/kinds/`. Selection criteria and the rules that separate the two forms.                                                                                                                   |
