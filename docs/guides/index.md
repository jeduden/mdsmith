...
| [Installation](install.md)                                                          | Every channel that ships the mdsmith binary or the VS Code extension — npm, PyPI, asdf, mise, the GitHub release, and the Visual Studio Marketplace plus Open VSX — and which channel to pick for which workflow. |
