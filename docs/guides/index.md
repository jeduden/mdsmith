...
| [Coexist with Prettier](coexist-with-prettier.md)                                   | Add `mdsmith fix` before `prettier --write` in the same pre-commit hook. mdsmith does not require changing your Prettier config.                                                                                                                                                      |
