...
mdsmith lsp binary. It surfaces inline diagnostics as
squiggles, a lightbulb quick fix for every fixable rule, a
whole-buffer fix action with optional fix-on-save and
