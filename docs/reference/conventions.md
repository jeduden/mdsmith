...
lists are sourced from [`slop-patterns.md`][slop]; a
...
sup]`. To keep the preset's entries, write `allow: [details, summary,
sub, sup]`. The `lists:` word-list key always appends — see
[word-list files](wordlist-files.md).
