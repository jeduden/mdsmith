...
**[Progressive disclosure for AI agents](docs/guides/progressive-disclosure.md).**
...
That command table and the feature list above are generated by mdsmith's own
directives. The same `<?catalog?>` machinery turns `CLAUDE.md` into a token-cheap
docs index for AI agents — the
[progressive disclosure guide](docs/guides/progressive-disclosure.md) is the recipe.
