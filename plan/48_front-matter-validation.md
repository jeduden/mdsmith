...
Validate YAML front matter in Markdown files against a schema to prevent silent metadata breakage in agent workflows.

## Tasks

1. Define schema format and configuration for required fields, types, and allowed values.
2. Parse front matter safely and report missing or invalid fields with actionable messages.
