...
2. Add archetype templates for common agent patterns (story-file, prd, agent-definition, claude-md).
3. Update required-structure rule to validate archetype selection and required sections.
