...
- [Install the mdsmith Obsidian plugin, configure how it spawns `mdsmith lsp`, and read diagnostics inline as you edit notes in your vault.](../docs/guides/editors/obsidian.md)
