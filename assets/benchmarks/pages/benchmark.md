...
[the PGO page](https://github.com/jeduden/mdsmith/blob/main/docs/development/pgo-profile.md)), so the
...
[`results.fragment.md`](https://github.com/jeduden/mdsmith/blob/main/docs/research/benchmarks/results.fragment.md), which `run.sh`
...
gap](https://github.com/jeduden/mdsmith/blob/main/docs/research/benchmarks/gomarklint-architecture.md) breaks the profile down bucket
...
matrix](https://github.com/jeduden/mdsmith/blob/main/docs/research/markdownlint-coverage/README.md). It is generated
