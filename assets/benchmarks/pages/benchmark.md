...
Reproduce it with [`run.sh`](https://github.com/jeduden/mdsmith/blob/main/docs/research/benchmarks/run.sh), a thin wrapper over
...
- Each tool runs its check/lint over a directory of `.md`
  ...
  with a per-peer
  [`bench-<linter>-parity.mdsmith.yml`](https://github.com/jeduden/mdsmith/blob/main/docs/research/benchmarks/bench-gomarklint-parity.mdsmith.yml)
...
[the PGO page](https://github.com/jeduden/mdsmith/blob/main/docs/development/pgo-profile.md)). The two are
...
[`results.fragment.md`](https://github.com/jeduden/mdsmith/blob/main/docs/research/benchmarks/results.fragment.md), which
...
gap](https://github.com/jeduden/mdsmith/blob/main/docs/research/benchmarks/gomarklint-architecture.md) reviews gomarklint's design,
...
[mdcov]: https://github.com/jeduden/mdsmith/blob/main/docs/research/markdownlint-coverage/README.md
...
[peer-linter coverage matrix](https://github.com/jeduden/mdsmith/blob/main/docs/research/markdownlint-coverage/README.md)
...
[`bench-<linter>-parity.mdsmith.yml`](https://github.com/jeduden/mdsmith/blob/main/docs/research/benchmarks/bench-mado-parity.mdsmith.yml)
...
[conv-parity]: https://github.com/jeduden/mdsmith/blob/main/docs/reference/conventions.md
...
- MD054 link-image-style is covered only by the opt-in
  [MDS068 link-style](https://github.com/jeduden/mdsmith/blob/main/internal/rules/MDS068-link-style/README.md)
...
- Three mdsmith-only rules (no markdownlint analog) are
  **not** in the parity disable list:
  [MDS031 unclosed-code-block](https://github.com/jeduden/mdsmith/blob/main/internal/rules/MDS031-unclosed-code-block/README.md)
  (default, kept on as a cheap structural check),
  [MDS034 markdown-flavor](https://github.com/jeduden/mdsmith/blob/main/internal/rules/MDS034-markdown-flavor/README.md),
  and
  [MDS067 callout-type](https://github.com/jeduden/mdsmith/blob/main/internal/rules/MDS067-callout-type/README.md)
